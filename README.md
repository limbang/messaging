...
![](https://github.com/limbang/messaging/blob/master/LICENSE)
[![](https://img.shields.io/github/v/release/limbang/messaging?include_prereleases)](https://github.com/limbang/messaging/releases)
...
WebSocket 默认使用 2333 端口，可在配置文件中修改
